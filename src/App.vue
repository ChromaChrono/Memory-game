...
<template>
<startScreen v-if="gameState === 'starting'" @values="handleStart($event)"></startScreen>
<carousel v-if="gameState === 'started'" :words="wordTable" @guessedWords="handleGuesses($event)"></carousel>
<EndScreen v-if="gameState === 'ended'" :words="wordTable" :totalWords="totalWords" :correctGuesses="correctGuesses" @restart="handleRestart"></EndScreen>
</template>
